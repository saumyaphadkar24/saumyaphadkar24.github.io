...
export default function AdvancedModelOverlay({ onClose, onNext, onPrev }) {
  return (
    <OverlayWrapper
      onClose={onClose}
      onNext={onNext}
      onPrev={onPrev}
      title="Advanced Model Fine-Tuning Applications"
      titleId="advancedmodel-title"
      subtitle="Python, PyTorch, NLP, DistilBERT, CodeBERT, MBART"
      headerColor="#FFDAB3"
    >
