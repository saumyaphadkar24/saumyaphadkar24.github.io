...
export default function SustainableShopperOverlay({ onClose, onNext, onPrev }) {
  return (
    <OverlayWrapper
      onClose={onClose}
      onNext={onNext}
      onPrev={onPrev}
      title="SustainableShopper: Virtual Try-On & Smart Wardrobe App"
      titleId="sustainableshopper-title"
      subtitle="HCI, HCD, Python, Flask, React, OpenAI API, CLIP, MongoDB"
      headerColor="#A9DDF5"
    >
